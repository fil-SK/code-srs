...
// Route: cards/:id/edit. Branches between the new Recall/Multiple Choice
// editors and the untouched v1 registry editor, since both still coexist
// during the transition (see docs/itera-decisions.md): a v1
// basic/codeReading/bugFinding card opens the Recall editor, a v1 mcq card
// opens the Multiple Choice editor (both migrate to a CardV2Record on save);
// a CardV2Record opens its matching editor directly by interaction type;

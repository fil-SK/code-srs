...
// Route: cards/:id/edit. Branches between the new Recall editor and the
// untouched v1 registry editor, since both still coexist during the
// transition (see docs/itera-decisions.md): a v1 basic/codeReading/bugFinding
// card opens the new editor (and gets migrated to a CardV2Record on save); a
// CardV2Record opens the new editor directly; anything else (the other five
// v1 types) falls through to the old CardEditorPage, unmodified.

...
// Choice/Write Code/Ordering/Matching editors and the untouched v1 registry
// editor, since both still coexist during the transition (see
...
// the Ordering editor, a v1 matching card opens the Matching editor (all
// five migrate to a CardV2Record on save); a CardV2Record opens its editor
// directly by interaction type; anything else (the remaining v1 types)
// falls through to the old CardEditorPage, unmodified.

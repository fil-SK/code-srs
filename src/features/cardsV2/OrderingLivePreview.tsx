...
// onExit is a no-op.
//
// Like MultipleChoiceLivePreview/WriteCodeLivePreview, ReviewSessionScreen
// only resets its internal phase/response state on remount, so this keys on
// an explicit resetKey counter, not on form content: normal edits (typing,
// adding an item) update the live card without discarding an in-progress
// reorder, and "Reset preview" is the only thing that remounts back to the
// unanswered state.

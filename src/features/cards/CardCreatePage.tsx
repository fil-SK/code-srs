...
import type { Card, InteractionType } from '@/types/card'
import { emptyRecallForm } from '@/domain/cards/recallForm'
import { emptyMultipleChoiceForm } from '@/domain/cards/multipleChoiceForm'
import { emptyWriteCodeForm } from '@/domain/cards/writeCodeForm'
import { emptyOrderingForm } from '@/domain/cards/orderingForm'
import { emptyMatchingForm } from '@/domain/cards/matchingForm'
...
export function CardCreatePage() {
  ...
  const onSaved = (record: Card) => navigate(`/decks/${record.deckId}`)

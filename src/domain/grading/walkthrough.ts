...
// packages/core/src/domain/grading/walkthrough.ts and is published as @itera/core.
//
...
export { aggregateWalkthroughResult, gradeWalkthroughStep, objectiveStepIds } from '@itera/core'

export type { WalkthroughStepAnswer } from '@itera/core'

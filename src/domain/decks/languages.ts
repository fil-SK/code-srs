...
// packages/core/src/domain/decks/languages.ts and is published as @itera/core.
//
...
export { DECK_LANGUAGES, languageLabel } from '@itera/core'

export type { DeckLanguageCode } from '@itera/core'

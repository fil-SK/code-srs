...
// packages/core/src/domain/stats/deckMetrics.ts and is published as @itera/core.
//
...
export { aggregateMetrics, computeDeckMetrics, metricsFor } from '@itera/core'

export type { CollectionMetrics, DeckMetrics } from '@itera/core'

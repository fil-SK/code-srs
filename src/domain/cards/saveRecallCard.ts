...
// packages/core/src/domain/cards/saveRecallCard.ts and is published as @itera/core.
//
...
export { saveRecallCard } from '@itera/core'

export type { SaveRecallCardTarget } from '@itera/core'

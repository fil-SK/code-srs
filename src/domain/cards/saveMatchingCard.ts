...
// packages/core/src/domain/cards/saveMatchingCard.ts and is published as @itera/core.
//
...
export { saveMatchingCard } from '@itera/core'

export type { SaveMatchingCardTarget } from '@itera/core'

...
// packages/core/src/domain/io/importFailure.ts and is published as @itera/core.
//
...
export { ImportFailure, describeImportFailure } from '@itera/core'

export type { ImportFailureStage } from '@itera/core'

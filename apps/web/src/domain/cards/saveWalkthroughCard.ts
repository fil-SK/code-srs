...
// packages/core/src/domain/cards/saveWalkthroughCard.ts and is published as @itera/core.
//
...
export { saveWalkthroughCard } from '@itera/core'

export type { SaveWalkthroughCardTarget } from '@itera/core'

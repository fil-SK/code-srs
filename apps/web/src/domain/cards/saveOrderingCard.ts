...
// packages/core/src/domain/cards/saveOrderingCard.ts and is published as @itera/core.
//
...
export { saveOrderingCard } from '@itera/core'

export type { SaveOrderingCardTarget } from '@itera/core'

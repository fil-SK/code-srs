...
// packages/core/src/domain/scheduling/reviewService.ts and is published as @itera/core.
//
...
export { reviewService } from '@itera/core'

export type { ReviewService, SubmitReviewCommand, SubmitReviewResult } from '@itera/core'

...
// packages/core/src/interactions/matchingBadgeGeometry.ts and is published as @itera/core.
//
...
export { placeMatchingBadges } from '@itera/core'

export type { CubicEdgeGeometry } from '@itera/core'

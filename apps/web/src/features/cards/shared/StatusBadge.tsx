...
// Renders the real state/suspended split from the card's scheduling rather
// than a flattened fictional enum — suspension is orthogonal to scheduling
// state, not a fifth state value. Promoted into production once the real Deck
// page needed it too (see docs/itera-decisions.md).
